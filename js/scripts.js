document.addEventListener('DOMContentLoaded', function() {
  const projects = [
    ...
    { id: 4, name: 'Application web pour une entreprise afin de gérer les comptes de ses clients', description: 'Application permettant de gérer les stocks d\'un magasin', image: 'img/Entreprise-privée.jpg', url: 'Entreprive-privée.html', play:'<svg xmlns="http://www.w3.org/2000/svg" height="26" width="26" viewBox="0 0 512 512" style="fill : #bbb"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M464 256A208 208 0 1 0 48 256a208 208 0 1 0 416 0zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zM188.3 147.1c7.6-4.2 16.8-4.1 24.3 .5l144 88c7.1 4.4 11.5 12.1 11.5 20.5s-4.4 16.1-11.5 20.5l-144 88c-7.4 4.5-16.7 4.7-24.3 .5s-12.3-12.2-12.3-20.9V168c0-8.7 4.7-16.7 12.3-20.9z"/></svg>'},
    ...
    { id: 6, name: 'How ?!', description: `Jeu d'escape game 3D sur le thème de l'Egypte antique (réalisé en équipe)`, image: 'img/How.png', url: 'https://www.youtube.com/watch?v=Z_WZ0Orbqj8&ab_channel=WeCanStudio' , play:'<svg xmlns="http://www.w3.org/2000/svg" height="26" width="26" viewBox="0 0 512 512" style="fill : #bbb"><!--!Font Awesome Free 6.5.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free Copyright 2024 Fonticons, Inc.--><path d="M464 256A208 208 0 1 0 48 256a208 208 0 1 0 416 0zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256zM188.3 147.1c7.6-4.2 16.8-4.1 24.3 .5l144 88c7.1 4.4 11.5 12.1 11.5 20.5s-4.4 16.1-11.5 20.5l-144 88c-7.4 4.5-16.7 4.7-24.3 .5s-12.3-12.2-12.3-20.9V168c0-8.7 4.7-16.7 12.3-20.9z"/></svg>' },
    { id: 7, name: 'Application de pétanque, tarrot, belote', description: 'Application permettant de constituer les équipes et le matchmaking réalisé pour un concours', image: 'img/Petanque.png', url: 'Petanque.html'},
